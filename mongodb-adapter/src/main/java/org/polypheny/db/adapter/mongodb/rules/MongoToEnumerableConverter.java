...
import org.polypheny.db.adapter.mongodb.MongoTable.MongoQueryable;
...
public class MongoToEnumerableConverter extends ConverterImpl implements EnumerableRel {
    ...
    public Result implement( EnumerableRelImplementor implementor, Prefer pref ) {
        ...
        final Expression table = list.append( "table", mongoImplementor.table.getExpression( MongoQueryable.class ) );
